...
def step_user_data_schema(data: dict[str, Any] = {CONF_NAME: SENSOR_PREFIX, CONF_INVERTER_PORT: DEFAULT_PORT_INVERTER, CONF_INVERTER_MB_SLAVEID: DEFAULT_INVERTER_MB_SLAVEID, CONF_LOOKUP_FILE: DEFAULT_LOOKUP_FILE, CONF_MAX_ATTEMPTS: DEFAULT_MAX_ATTEMPTS, CONF_TIME_OUT: DEFAULT_TIME_OUT}) -> Schema:
    ...
    STEP_USER_DATA_SCHEMA = vol.Schema(
        {
            ...
            vol.Optional(CONF_TIME_OUT, default=data.get(CONF_TIME_OUT)): int,
            vol.Optional(CONF_MAX_ATTEMPTS, default=data.get(CONF_MAX_ATTEMPTS)): int,                        
        },
